    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http)
        ...
        http.formLogin(c ->
                ...
                .authorizeHttpRequests(c -> c.requestMatchers("/bootstrap/**","/","/home","/account/**")
                        ...
                        .hasAnyRole("CUSTOMER_PAGE_VIEW", "CUSTOMER_READ","SUPER_ADMIN")
                        .requestMatchers("/customer/**").hasRole("SUPER_ADMIN")

                        .requestMatchers("/department/list-departments","/department/department-form","/department/save-department")
                        .hasAnyRole("DEPARTMENT_PAGE_VIEW", "DEPARTMENT_READ",
